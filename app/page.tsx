...
export default function Home() {
    return (
        <div>
            ...
            <p className="mt-16 text-center">
                Diese Website ist Teil einer Bachelorarbeit an der FH Hagenberg.
                <br />
                Ziel der Arbeit ist es, die Vorteile von ID Austria zu
                analysieren und praktische Beispiele für die Implementierung
                bereitzustellen sowie eventuelle Herausforderungen zu
                identifizieren und zu dokumentieren.
            </p>

            <div className="mt-4 mb-2 text-xs flex flex-col items-center">
                <p className="mt-8 mb-8 text-lg">Kontakt</p>
                <div>
